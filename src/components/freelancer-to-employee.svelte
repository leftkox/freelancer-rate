...
<div>
	<div class="form-label mdc-typography--body1" style="margin-top: 30px;">
		1. Enter your daily rate as a freelancer
	</div>
	...
	<div style="margin-top: 30px;">
		{#if dailyRate !== undefined}
			<div class="mdc-typography--body1" style="margin-top: 20px">
				A daily rate of {currencySymbols[fromCurrency]}{dailyRate} gross is equivalent to a net annual
				salary of {currencySymbols[toCurrency]}{Math.round(netSalary ?? 0)}.
			</div>
		{/if}
	</div>
</div>
